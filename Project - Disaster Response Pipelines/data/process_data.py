...
def load_data(messages_filepath, categories_filepath):
    ...
    @param - messages_filepath - string - file name / path for the message data frame
    @param - categories_filepath - string - file name / path for the categories data frame
...
def clean_data(df):
    '''
    Clean up the data frame, remove duplicates and dropping column 'child_alone'

    @param - df - the dataframe which should be clean up
    @return - new dataframe
    '''
    # dropping duplicates
    df2 = df.drop_duplicates( subset = ['message'] )
    # dropping column 'child_alone'
...
def save_data(df, database_filename):
    '''
    Saving the data frame into an SQL database.

    @param - df - the dataframe which should be saved
